...
public class App 
{
	public static void main( String[] args )
    {
		...
		imprimirInformacionEstudiante(estudiante1, textoEstudiante);
        
    }

	private static void imprimirInformacionEstudiante(Estudiante estudiante1, String textoEstudiante) {
